...
set snd_clk   "pll_aud|altpll_component|auto_generated|pll1|clk[1]"
...
set_clock_groups -asynchronous -group [get_clocks {pll|altpll_component|auto_generated|pll1|clk[3]}] -group [get_clocks {pll_aud|altpll_component|auto_generated|pll1|clk[*]}]
